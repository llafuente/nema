...
class AngularApi {
    constructor(config) {
        ...
        fs.copyFileSync(path.join(this.config.api.root, "templates", "angular5client", "tsconfig.json"), path.join(this.config.dstPath, "tsconfig.json"));
        fs.copyFileSync(path.join(this.config.api.root, "templates", "angular5client", "RequestOptions.ts"), path.join(this.config.dstPath, "src", "RequestOptions.ts"));
...
exports.AngularApi = AngularApi;
//# sourceMappingURL=AngularApi.js.map