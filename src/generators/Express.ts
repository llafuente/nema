...
*/
  ...
  static indexFile(api: Api, filename: string) {
    CommonGenerator.writeModificableTemplate(filename, Express.index(api));
  }

  static routesFile(api: Api, filename: string) {
    fs.writeFileSync(filename, Express.routes(api));
  }

  static routeFile(api: Api, method: Method, filename: string) {
...
`;
  ...
  static route(api: Api, method: Method): ModificableTemplate {
...
`
  ...
  static index(api: Api): ModificableTemplate {
return {
