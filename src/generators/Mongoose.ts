...
export class Mongoose {
  ...
  static generate(api: Api, dstPath: string, pretty: boolean, lint: boolean) {
    api.sort();
  ...
  static mongooseRepositoryFile(api: Api, model: Model, filename: string) {
...
`);
  ...
  static mongooseRepository(api: Api, model: Model): string {
    const s = [];
